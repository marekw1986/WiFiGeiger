...
static uint8_t ICACHE_FLASH_ATTR bcdToDec(uint8_t bcd) {
...
// returns true to indicate success
bool ICACHE_FLASH_ATTR ds3231_getFlag(uint8_t addr, uint8_t mask, uint8_t *flag) {
	uint8_t data[1];
	// get register
	data[0] = addr;
...
// returns true to indicate success
bool ICACHE_FLASH_ATTR ds3231_setFlag(uint8_t addr, uint8_t bits, uint8_t mode) {
	uint8_t data[2];
	data[0] = addr;
	// get status register
...
// returns true to indicate success
bool ICACHE_FLASH_ATTR ds3231_clearAlarmFlags(uint8_t alarms) {
